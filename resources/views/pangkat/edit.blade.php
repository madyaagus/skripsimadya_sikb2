...
@section('content')
    ...
    <!-- START FORM -->
    <form action='{{ url('pangkat/'.$data->id_pangkat) }}' method='post'>
        @csrf 
        @method('PUT')
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <h3 style="background-color:powderblue;">Edit Data {{ $data->nama_pangkat }}</h3>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='nama_pangkat' id="nama_pangkat" value="{{ $data->nama_pangkat }}">
                </div>
                {{-- <div class="col-sm-10">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='keterangan_pangkat' id="keterangan_pangkat" value="{{ $data->keterangan_pangkat }}">
                </div>
            </div>
            <div class="mb-3 row">
