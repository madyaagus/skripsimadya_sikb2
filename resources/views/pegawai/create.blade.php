                ...
                @include('komponen.pesan')
                    ...
                    <form action='{{ url('pegawai') }}' method='post' enctype="multipart/form-data">
                        ...
                        <div class="my-3 p-3 bg-body rounded shadow-sm">
                            <h3 style="background-color:powderblue;">Tambah Data Pegawai</h3>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='nama_pegawai' id="nama_pegawai" value="{{ Session::get('nama_pegawai')}}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name='status' id="status">
                                        <option value="">--Pilih--</option>
                                        <option value="Tata Usaha" {{ Session::get('status') == 'Tata Usaha' ? 'selected' : '' }}>Tata Usaha</option>
                                        <option value="Jaksa" {{ Session::get('status') == 'Jaksa' ? 'selected' : '' }}>Jaksa</option>
                                    </select>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" class="form-control" name='foto' id="foto" value="{{ Session::get('foto')}}">
                                </div>
                            </div>
                            <div class="mb-3 row">
