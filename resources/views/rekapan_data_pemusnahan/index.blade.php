...
<title>Rekapan Data Pemusnahan</title>
        ...
        <div class="content container-fluid">
          <body class="bg-light">
            <main class="container">
               <h3>Rekapan Data Pemusnahan (BA-23)</h3>
            ...
            <script>
              function generatePrintUrl() {
                  ...
                  var printUrl = '{{ route("rekapan-data-pemusnahan-filter", ["start_date" => ":start_date", "end_date" => ":end_date"]) }}';
