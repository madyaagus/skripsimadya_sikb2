          ...
          <body class="bg-light">
            <main class="container">
                @include('komponen.pesan')
                    ...
                    <!-- START FORM -->
                    <form action='{{ url('beritaacara/ba20') }}' method='post'>
                        @csrf 
                        <div class="my-3 p-3 bg-body rounded shadow-sm">
                            <h3 style="background-color:powderblue;">Tambah Data Pengembalian</h3>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='dikembalikan' id="dikembalikan" value="{{ Session::get('dikembalikan')}}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="nama_penerima" class="col-sm-2 col-form-label">Nama Penerima</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='nama_penerima' id="nama_penerima" value="{{ Session::get('nama_penerima')}}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="pekerjaan_ba20" class="col-sm-2 col-form-label">Pekerjaan</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='pekerjaan_ba20' id="pekerjaan_ba20" value="{{ Session::get('pekerjaan_ba20')}}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="alamat_ba20" class="col-sm-2 col-form-label">Alamat</label>
                                <div class="col-sm-10">
                                    <textarea name="alamat_ba20" id="alamat_ba20" class="form-control">{{ Session::get('alamat_ba20')}}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="barang_bukti_ba20" id="barang_bukti_ba20" class="form-control">{{ Session::get('barang_bukti_ba20')}}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="dokumentasi" class="col-sm-2 col-form-label">Dokumentasi</label>
                                <div class="col-sm-10">
                                    <input type="url" class="form-control" name="dokuemntasi" id="dokumentasi" placeholder="Masukkan tautan Google Drive" value="{{ Session::get('dokumentasi') }}">
