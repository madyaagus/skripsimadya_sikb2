...
<title>Rekapan Data Bensus</title>
        ...
        <div class="content container-fluid">
          <body class="bg-light">
            <main class="container">
              <h3>Rekapan Data Bensus</h3>

                  <!-- START DATA -->
                  <div class="my-3 p-3 bg-body rounded shadow-sm">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 10px;">
                      <form action="/rekapan-data-bensus/filter" method="GET"> 
                      ...
                      <table class="table table-striped">
                          <thead>
                              <tr>
                                  ...
                                  <th class="col-md-3">TUJUAN SETORAN</th>
            ...
            <script>
              function generatePrintUrl() {
                  ...
                  var printUrl = '{{ route("rekapan-data-bensus-filter", ["start_date" => ":start_date", "end_date" => ":end_date"]) }}';
