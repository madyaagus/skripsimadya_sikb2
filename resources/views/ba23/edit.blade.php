...
@section('content')
    ...
    <!-- START FORM -->
    <form action='{{ url('beritaacara/ba23/'.$data->id_ba23) }}' method='post'>
        @csrf 
        @method('PUT')
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" name='tgl_ba23' id="tgl_ba23" value="{{ $data->tgl_ba23 }}">
                </div>
            </div>  
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <textarea name="barang_bukti_ba23" id="barang_bukti_ba23" class="form-control">{{ $data->barang_bukti_ba23 }}</textarea>
                </div>
            </div>
            <div class="mb-3 row">
