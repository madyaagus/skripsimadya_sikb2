...
<title>Tambah Peminjaman BB</title>
          ...
          <body class="bg-light">
            <main class="container">
                @include('komponen.pesan')
                    ...
                    <!-- START FORM -->
                    <form action='{{ url('peminjaman_bb') }}' method='post'>
                        @csrf 
                        <div class="my-3 p-3 bg-body rounded shadow-sm">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name='tgl_peminjaman' id="tgl_peminjaman" value="{{ Session::get('tgl_peminjaman')}}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='jadwal_ambil' id="jadwal_ambil" value="{{ Session::get('jadwal_ambil')}}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="jadwal_kembali" class="col-sm-2 col-form-label">Jadwal Kembali</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='jadwal_kembali' id="jadwal_kembali" value="{{ Session::get('jadwal_kembali')}}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="dokumentasi_bon" class="col-sm-2 col-form-label">Dokumentasi BON</label>
                                <div class="col-sm-10">
                                    <input type="url" class="form-control" name="dokumentasi_bon" id="dokumentasi_bon" placeholder="Masukkan tautan Google Drive" value="{{ Session::get('dokumentasi_bon') }}">
